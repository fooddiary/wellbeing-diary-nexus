...
export const AddEntryButton = () => {
  ...
  return <>
      <Popover open={openPopover} onOpenChange={setOpenPopover}>
        ...
        <PopoverContent className="w-48 p-2" side="top">
          <div className="flex flex-col space-y-2">
            <Button variant="outline" className="justify-start text-left" onClick={handleAddMeal}>
              🍽️ Приём пищи
            </Button>
            <Button variant="outline" className="justify-start text-left" onClick={handleAddWater}>
              💧 Вода
            </Button>
          </div>
        </PopoverContent>
      ...
      <AddMealForm open={openMealForm} onOpenChange={setOpenMealForm} />
